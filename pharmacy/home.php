...
<body>
  <div class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class=" navbar-inner" style="background: #0bacdc;">
      <div class="container-fluid">
        ...
        <a class="brand" href="#"><b>Nepal Medical System</b></a>
        <div class="nav-collapse">

          <ul class="nav pull-right">
            <li style="color: #ffffff ;padding: 10px;">
              <font color="white" size="5">Sales:</font>
              <strong><?php
            ...
            <li><a href="product/view.php?invoice_number=<?php echo $_GET['invoice_number'] ?>"><span class="icon-medkit"></span>Products</a></li>
             <li><a href="../medicines/index.php"><span class="icon-tasks"></span>Alternate Medicine</a></li>
            <li><a href="../price/index.php"><span class="icon-money"></span>Price Comparison</a></li>
  ...
  <div class="container bg-blufd mt-35">
    <div class="contentheader">
      <h1>Sell Medicine</h1>
    </div><br><br>

    
      <form method="POST" action="insert_invoice.php?invoice_number=<?php echo $_GET['invoice_number'] ?> " class="pdn-left">
        <div class="row">
          <div class="col-md-6">
            <input type="text" name="bar_code" id="bar_code" autocomplete="off" placeholder="Lic. No scan here" style="height: 30px;" class="wid-inpt">
          </div>
          <div class="col-md-6">
            <input type="text" id="product" required autocomplete="off" placeholder="Enter Medicine Name" style="height: 30px;" class="wid-inpt">
          </div>
          <div class="col-md-6">
            <div class="ui-widget">
              <input type="hidden" name="product" id="product_hidden" required class="form-control" autocomplete="off" class="wid-inpt" placeholder="Enter Medicine Name" style="height: 30px;">
            </div>
          </div>
          <div class="col-md-6">
          <input type="hidden" name="expire_date" id="date_hidden" required class="form-control" autocomplete="off" class="wid-inpt" placeholder="Enter Medicine Name" style="height: 30px;">
          </div>
          <div class="col-md-6">
            <input type="number" name="avai_qty" id="avai_qty" readonly placeholder="Available qty" style="height:30px;" class="wid-inpt">
          </div>
          <div class="col-md-6">
            <input type="number" name="qty" id="qty" placeholder="Qty" autocomplete="off" style="height:30px;" class="wid-inpt" required>
          </div>
          <div class="col-md-6">
            <input type="hidden" name="date" value="<?php echo date("m/d/Y"); ?>" class="wid-inpt">
          </div>
          <div class="col-md-6">
          <Button type="submit" name="submit" class="btn btn-info" id="btn_submit"  style="width: 123px; height:40px;" />Add</button>
          </div>
        </div>
  ...
  <div class="container mt-35" style="overflow-x:auto; overflow-y: auto;background: #f9f9f9;padding: 30px;">
    <table class="table table-bordered" id="resultTable" data-responsive="table">
      ...
      <thead>
        <tr>
          <th> Medicine Name </th>
          <th> Category</th>
          <th style="background: red;color: #fff;"> Expire_date</th>
          <th> Price </th>
          <th> Qty </th>
          <th> Amount </th>
          <th> Action </th>
