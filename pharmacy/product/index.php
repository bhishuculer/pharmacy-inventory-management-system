...
<body>
 	 	<form method="POST" action="register.php?invoice_number=<?php echo $_GET['invoice_number']?>">
  	  	 ...
  	  	 <tr>
         <td>Lic. No</td>
         <td><input type="text" name="bar_code" id="bar_code" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" placeholder="Enter Your Lic. No" required></td>
          </tr>
          <tr id="row1">
         <td>Medicine Name:</td>
        ...
        <td><input type="number" style="width: 95px;" name="quantity">
             ...
             <option value="Tab">Tab</option>
                 <option value="Stp">Sachet</option>	
                <option value="Unit">Ointment</option>
